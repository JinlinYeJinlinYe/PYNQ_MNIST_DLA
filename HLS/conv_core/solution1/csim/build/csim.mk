# ==============================================================
# File generated on Sun Nov 06 11:38:11 +0800 2022
...
HLS_SOURCES = ../../../conv_core_tb.cpp ../../../conv_core.cpp
...
$(ObjDir)/conv_core_tb.o: ../../../conv_core_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../conv_core_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/conv_core_tb.d
